    ...
    <>
      ...
      <form action={addNewTodo} className="flex flex-col gap-4 w-3/12">
        <input
          name="content"
          type="text"
          className="border-2 border-black/20 rounded"
        />
        <button
          className="bg-blue-500 border border-blue-500 text-white py-2 rounded w-28 hover:bg-white hover:text-blue-800"
          type="submit"
        >
          Add Todo
        </button>
