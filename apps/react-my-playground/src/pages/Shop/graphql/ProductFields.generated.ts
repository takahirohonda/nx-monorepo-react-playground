...
export type ProductOption_CheckboxOption_Fragment = { __typename: 'CheckboxOption', entityId: number, displayName: string, isRequired: boolean };

export type ProductOption_DateFieldOption_Fragment = { __typename: 'DateFieldOption', entityId: number, displayName: string, isRequired: boolean };

export type ProductOption_FileUploadFieldOption_Fragment = { __typename: 'FileUploadFieldOption', entityId: number, displayName: string, isRequired: boolean };

export type ProductOption_MultiLineTextFieldOption_Fragment = { __typename: 'MultiLineTextFieldOption', entityId: number, displayName: string, isRequired: boolean };

export type ProductOption_MultipleChoiceOption_Fragment = { __typename: 'MultipleChoiceOption', displayStyle: string, entityId: number, displayName: string, isRequired: boolean, values: { __typename?: 'ProductOptionValueConnection', edges: Array<{ __typename?: 'ProductOptionValueEdge', node: { __typename?: 'MultipleChoiceOptionValue', entityId: number, label: string, isSelected: boolean | null, isDefault: boolean } | { __typename?: 'ProductPickListOptionValue', entityId: number, label: string, isSelected: boolean | null, isDefault: boolean } | { __typename?: 'SwatchOptionValue', hexColors: Array<string>, imageUrl: string | null, label: string, isSelected: boolean | null, entityId: number, isDefault: boolean } }> | null } };

export type ProductOption_NumberFieldOption_Fragment = { __typename: 'NumberFieldOption', entityId: number, displayName: string, isRequired: boolean };

export type ProductOption_TextFieldOption_Fragment = { __typename: 'TextFieldOption', entityId: number, displayName: string, isRequired: boolean };
