...
export type AddCustomerAddressError =
...
export type CartSelectedOptionsInput = {
  ...
  multiLineTextFields?: InputMaybe<
    Array<CartSelectedMultiLineTextFieldOptionInput>
  >
...
export type CheckoutAddressCheckboxesCustomField =
...
export type CheckoutAddressCustomFieldInput = {
  ...
  multipleChoices?: InputMaybe<
    Array<CheckoutAddressMultipleChoiceCustomFieldInput>
  >
...
export type CheckoutAddressMultipleChoiceCustomField =
  CheckoutAddressCustomField & {
...
export type DeleteCartMetafieldError =
  | NotAuthorisedError
  | NotFoundError
  | ValidationError
